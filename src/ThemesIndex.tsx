...
const THEMES: Theme[] = [
  ...
  },
  {
    ...
    href: '/agente/estados',
    status: 'next',
    eyebrow: 'En evaluación · nuevo',
    title: 'Workflows / Estados / Lógicas',
    blurb: 'Reescritura del canvas de workflows: un único concepto de estado, con dos vistas (clásica con avanzado mixto, o unificada con panel fijo).',
    bullets: ['Estados simples + avanzados', '2 vistas (Clásica / Unificada)', 'Datos requeridos + condiciones en edges'],
