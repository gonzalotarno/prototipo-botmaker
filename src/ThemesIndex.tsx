...
const THEMES: Theme[] = [
  ...
  },
  {
    ...
    blurb: 'Editor de workflow del agente: estados simples, instrucciones por estado y opción de agregar un flujo de lógica adentro de cada uno.',
    bullets: ['Estados siempre simples, drawer de config', 'Instrucciones del estado para la IA', 'Botón "Agregar flujo" por estado'],
